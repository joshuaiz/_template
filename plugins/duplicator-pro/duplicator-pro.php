...
{
	// Don't even bother checking updates if license key isn't filled in since that will just create unnecessary traffic
	$dpro_edd_opts =  array('version' => DUPLICATOR_PRO_VERSION, 'license' => $license_key, 'item_name' => EDD_DUPPRO_ITEM_NAME, 'author' => 'Snap Creek Software');
