					...
					<div class="inside">
						...
						<div id="PO-custom-post-type-container" class="stuffbox">
							<h4>
							  ...
							  <a href="#" onclick="PO_display_ui_dialog('Custom Post Type Support', 'This is a list of registered post types on your wordpress install.  Select the checkbox next to the post types you would like to disable/enable plugins on.  If a post type is not selected then the list of plugins will not appear on the post edit screen.');return false;">
								<span class="dashicons PO-dashicon dashicons-editor-help"></span>
							  </a>
							</h4>
